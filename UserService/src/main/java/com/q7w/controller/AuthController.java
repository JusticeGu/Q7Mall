...
//        Payload payload = JSONUtil.toBean(userStr, Payload.class);
        String jti = RequestUtils.getJti();
        Long id = RequestUtils.getUserId();
        //String clientid = parameters.get("client-id");
        redisService.set(AuthConstant.User_Auth_KEY+":"+id,jti,3600*24);
